...
from torchvision.transforms import Compose, Resize, CenterCrop, ToTensor, Normalize, RandomResizedCrop, RandomRotation
...
def _transform(n_px: int, is_train: bool):
    ...
    if is_train:
        return Compose([
            ...
            RandomResizedCrop(n_px, scale=(0.95, 1.0), interpolation=Image.BICUBIC),
            _convert_to_rgb,
            ToTensor(),
            normalize,
        ])
